...
window.onload = function(){
	var oBox = document.getElementById('a_1');
	var oLeft = document.getElementById('up');
	var oRight = document.getElementById('down');
	var oConter = document.getElementById('mid');
